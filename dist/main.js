...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	global.Immutable = __webpack_require__(/*! immutable */ 2);
	
	var Chart = React.createClass({displayName: 'Chart',
	  componentDidUpdate: function (prevProps) {
	    console.log('this.props.chart:',this.props.chart.toJS());
	    console.log('prevProps.chart:',prevProps.chart.toJS());
	    console.log('Immutable.is:', Immutable.is(this.props.chart, prevProps.chart));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sequence = __webpack_require__(/*! ./Sequence */ 4).Sequence;
	var ImmutableMap = __webpack_require__(/*! ./Map */ 5);
	var OrderedMap = __webpack_require__(/*! ./OrderedMap */ 6);
	var ImmutableSet = __webpack_require__(/*! ./Set */ 7);
	var Vector = __webpack_require__(/*! ./Vector */ 8);
	var Range = __webpack_require__(/*! ./Range */ 9);
	var Repeat = __webpack_require__(/*! ./Repeat */ 10);
	var Record = __webpack_require__(/*! ./Record */ 11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Immutable = __webpack_require__(/*! ./Immutable */ 2);
	  ...
	  Sequence.prototype.toVector=function() {"use strict";
	    ...
	    assertNotInfinite(this.length);
	    return __webpack_require__(/*! ./Vector */ 8).from(this);
	  };
	
	  Sequence.prototype.toMap=function() {"use strict";
	    // Use Late Binding here to solve the circular dependency.
	    assertNotInfinite(this.length);
	    return __webpack_require__(/*! ./Map */ 5).from(this);
	  };
	
	  Sequence.prototype.toOrderedMap=function() {"use strict";
	    // Use Late Binding here to solve the circular dependency.
	    assertNotInfinite(this.length);
	    return __webpack_require__(/*! ./OrderedMap */ 6).from(this);
	  };
	
	  Sequence.prototype.toSet=function() {"use strict";
	    // Use Late Binding here to solve the circular dependency.
	    assertNotInfinite(this.length);
	    return __webpack_require__(/*! ./Set */ 7).from(this);
	  };
	  ...
	  Sequence.prototype.groupBy=function(mapper, context) {"use strict";
	    var seq = this;
	    var groups = __webpack_require__(/*! ./OrderedMap */ 6).empty().withMutations(function(map)  {
...
/***/ function(module, exports, __webpack_require__) {
	...
	for(var Sequence____Key in Sequence){if(Sequence.hasOwnProperty(Sequence____Key)){Map[Sequence____Key]=Sequence[Sequence____Key];}}var ____SuperProtoOfSequence=Sequence===null?null:Sequence.prototype;Map.prototype=Object.create(____SuperProtoOfSequence);Map.prototype.constructor=Map;Map.__superConstructor__=Sequence;
	  ...
	  Map.prototype.__deepEqual=function(other) {"use strict";
	    var is = __webpack_require__(/*! ./Immutable */ 2).is;
	...
	for(var ImmutableMap____Key in ImmutableMap){if(ImmutableMap.hasOwnProperty(ImmutableMap____Key)){OrderedMap[ImmutableMap____Key]=ImmutableMap[ImmutableMap____Key];}}var ____SuperProtoOfImmutableMap=ImmutableMap===null?null:ImmutableMap.prototype;OrderedMap.prototype=Object.create(____SuperProtoOfImmutableMap);OrderedMap.prototype.constructor=OrderedMap;OrderedMap.__superConstructor__=ImmutableMap;
	  ...
	  OrderedMap.prototype.set=function(k, v) {"use strict";
	    ...
	    if (newMap) {
	      ...
	      newVector = __webpack_require__(/*! ./Vector */ 8).empty().__ensureOwner(this.__ownerID).set(0, [k, v]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SequenceModule = __webpack_require__(/*! ./Sequence */ 4);
	var ImmutableMap = __webpack_require__(/*! ./Map */ 5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexedSequence = __webpack_require__(/*! ./Sequence */ 4).IndexedSequence;
	var Vector = __webpack_require__(/*! ./Vector */ 8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDescriptor = __webpack_require__(/*! ./ReactDescriptor */ 20);
	var ReactDOM = __webpack_require__(/*! ./ReactDOM */ 21);
	var ReactDOMComponent = __webpack_require__(/*! ./ReactDOMComponent */ 22);
	var ReactDefaultInjection = __webpack_require__(/*! ./ReactDefaultInjection */ 23);
	var ReactInstanceHandles = __webpack_require__(/*! ./ReactInstanceHandles */ 24);
	var ReactMount = __webpack_require__(/*! ./ReactMount */ 25);
	var ReactMultiChild = __webpack_require__(/*! ./ReactMultiChild */ 26);
	var ReactPerf = __webpack_require__(/*! ./ReactPerf */ 27);
	var ReactPropTypes = __webpack_require__(/*! ./ReactPropTypes */ 28);
	var ReactServerRendering = __webpack_require__(/*! ./ReactServerRendering */ 29);
	var ReactTextComponent = __webpack_require__(/*! ./ReactTextComponent */ 30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCurrentOwner = __webpack_require__(/*! ./ReactCurrentOwner */ 19);
	var ReactDescriptor = __webpack_require__(/*! ./ReactDescriptor */ 20);
	var ReactDescriptorValidator = __webpack_require__(/*! ./ReactDescriptorValidator */ 43);
	var ReactEmptyComponent = __webpack_require__(/*! ./ReactEmptyComponent */ 44);
	var ReactErrorUtils = __webpack_require__(/*! ./ReactErrorUtils */ 45);
	var ReactOwner = __webpack_require__(/*! ./ReactOwner */ 38);
	var ReactPerf = __webpack_require__(/*! ./ReactPerf */ 27);
	var ReactPropTransferer = __webpack_require__(/*! ./ReactPropTransferer */ 46);
	var ReactPropTypeLocations = __webpack_require__(/*! ./ReactPropTypeLocations */ 47);
	var ReactPropTypeLocationNames = __webpack_require__(/*! ./ReactPropTypeLocationNames */ 48);
	var ReactUpdates = __webpack_require__(/*! ./ReactUpdates */ 39);
	...
	var keyMirror = __webpack_require__(/*! ./keyMirror */ 41);
	var merge = __webpack_require__(/*! ./merge */ 42);
	var mixInto = __webpack_require__(/*! ./mixInto */ 50);
	var monitorCodeUse = __webpack_require__(/*! ./monitorCodeUse */ 51);
	var mapObject = __webpack_require__(/*! ./mapObject */ 52);
	var shouldUpdateReactComponent = __webpack_require__(/*! ./shouldUpdateReactComponent */ 53);
	var warning = __webpack_require__(/*! ./warning */ 37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(/*! ./DOMProperty */ 34);
	var DOMPropertyOperations = __webpack_require__(/*! ./DOMPropertyOperations */ 13);
	var ReactBrowserComponentMixin = __webpack_require__(/*! ./ReactBrowserComponentMixin */ 69);
	var ReactComponent = __webpack_require__(/*! ./ReactComponent */ 16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentBrowserEnvironment =
	  __webpack_require__(/*! ./ReactComponentBrowserEnvironment */ 70);
	var ReactDefaultBatchingStrategy = __webpack_require__(/*! ./ReactDefaultBatchingStrategy */ 71);
	var ReactDOM = __webpack_require__(/*! ./ReactDOM */ 21);
	var ReactDOMButton = __webpack_require__(/*! ./ReactDOMButton */ 72);
	var ReactDOMForm = __webpack_require__(/*! ./ReactDOMForm */ 73);
	var ReactDOMImg = __webpack_require__(/*! ./ReactDOMImg */ 74);
	var ReactDOMInput = __webpack_require__(/*! ./ReactDOMInput */ 75);
	var ReactDOMOption = __webpack_require__(/*! ./ReactDOMOption */ 76);
	var ReactDOMSelect = __webpack_require__(/*! ./ReactDOMSelect */ 77);
	var ReactDOMTextarea = __webpack_require__(/*! ./ReactDOMTextarea */ 78);
	var ReactEventListener = __webpack_require__(/*! ./ReactEventListener */ 79);
	var ReactInjection = __webpack_require__(/*! ./ReactInjection */ 80);
	var ReactInstanceHandles = __webpack_require__(/*! ./ReactInstanceHandles */ 24);
	var ReactMount = __webpack_require__(/*! ./ReactMount */ 25);
	var SelectEventPlugin = __webpack_require__(/*! ./SelectEventPlugin */ 81);
	var ServerReactRootIndex = __webpack_require__(/*! ./ServerReactRootIndex */ 82);
	var SimpleEventPlugin = __webpack_require__(/*! ./SimpleEventPlugin */ 83);
	var SVGDOMPropertyConfig = __webpack_require__(/*! ./SVGDOMPropertyConfig */ 84);
	
	var createFullPageComponent = __webpack_require__(/*! ./createFullPageComponent */ 85);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(/*! ./ReactDefaultPerf */ 86);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flattenChildren = __webpack_require__(/*! ./flattenChildren */ 60);
	var instantiateReactComponent = __webpack_require__(/*! ./instantiateReactComponent */ 49);
	var shouldUpdateReactComponent = __webpack_require__(/*! ./shouldUpdateReactComponent */ 53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(/*! ./emptyFunction */ 90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactServerRenderingTransaction =
	  __webpack_require__(/*! ./ReactServerRenderingTransaction */ 94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(/*! ./EventConstants */ 56);
	var EventPluginHub = __webpack_require__(/*! ./EventPluginHub */ 100);
	var EventPropagators = __webpack_require__(/*! ./EventPropagators */ 101);
	var ExecutionEnvironment = __webpack_require__(/*! ./ExecutionEnvironment */ 32);
	var ReactUpdates = __webpack_require__(/*! ./ReactUpdates */ 39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventListener = __webpack_require__(/*! ./EventListener */ 113);
	var ExecutionEnvironment = __webpack_require__(/*! ./ExecutionEnvironment */ 32);
	var PooledClass = __webpack_require__(/*! ./PooledClass */ 54);
	var ReactInstanceHandles = __webpack_require__(/*! ./ReactInstanceHandles */ 24);
	var ReactMount = __webpack_require__(/*! ./ReactMount */ 25);
	...
	var getUnboundedScrollPosition = __webpack_require__(/*! ./getUnboundedScrollPosition */ 115);
	var mixInto = __webpack_require__(/*! ./mixInto */ 50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewportMetrics = __webpack_require__(/*! ./ViewportMetrics */ 130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var copyProperties = __webpack_require__(/*! ./copyProperties */ 132);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var accumulate = __webpack_require__(/*! ./accumulate */ 140);
